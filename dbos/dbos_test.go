...
func TestConfig(t *testing.T) {
	...
	t.Run("SystemDBMigration", func(t *testing.T) {
		...
		// Verify migration version is 10 (after initial migration, queue partition key migration, workflow status index migration, forked_from migration, step timestamps migration, workflow events history migration, owner_xid migration, parent_workflow_id migration, workflow_schedules migration, and notifications primary key migration)
		var version int64
		var count int
